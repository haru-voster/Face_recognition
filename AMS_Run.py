    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/harou/OneDrive/Desktop/recognizer/Face-Recognition/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\harou\OneDrive\Desktop\recognizer\Face-Recognition\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/harou/OneDrive/Desktop/recognizer/Face-Recognition/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\harou\OneDrive\Desktop\recognizer\Face-Recognition\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'VOSTER':#changed admin
            if password == 'voster123':#admin password
                ...
                cs = 'C:/Users/harou/OneDrive/Desktop/recognizer/Face-Recognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
